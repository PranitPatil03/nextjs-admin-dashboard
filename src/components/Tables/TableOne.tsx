import { UserType } from "@/types/brand";
import Image from "next/image";

const brandData: UserType[] = [
  {
      ...
      <div className="flex flex-col">
        ...
        {brandData.map((brand, key) => (
          ...
          >
            ...
            <div
              className={`border-[#eee] px-4 py-4 text-center dark:border-dark-3 ${key === brandData.length - 1 ? "border-b-0" : "border-b"}`}
            >
              <p
            ...
            <div
              className={`text-center border-[#eee] px-8 py-4 dark:border-dark-3 xl:pr-5.5 ${key === brandData.length - 1 ? "border-b-0" : "border-b"}`}
            >
